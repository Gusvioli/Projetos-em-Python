...
class Blackjack(object):
    ...
    def resultado(self,val,opcoes):
        ...
        while True:
            ...
            while x <= 1:
                while True:
                    ...
                    if self.indice_crouper in self.dic_b_novo_crouper:
                        ...
                        self.ind_val_format = {"{}".format(self.indice_crouper): self.valor_crouper}
            ...
            while x <= 1:
                while True:
                    ...
                    if self.indice_jogador in self.dic_b_novo_jogador:
                        ...
                        self.ind_val_format = {"{}".format(self.indice_jogador): self.valor_jogador}
            ...
            print("\033[36mSua Carteira inicial:\033[m ${}".format(self.cartera_jogador[0]))
            ...
            if int(self._up_aposta_entrada_jogador_) == 1:
                self._up_aposta_entrada_jogador_in = {"{}".format("Aposta"):min(self.lista_valor_aposta)}
                self.dic_b_novo_jogador_aposta.update(self._up_aposta_entrada_jogador_in)
                break
            elif int(self._up_aposta_entrada_jogador_) == 2:
                self._up_aposta_entrada_jogador_in = {"{}".format("Aposta"):max(self.lista_valor_aposta)}
                self.dic_b_novo_jogador_aposta.update(self._up_aposta_entrada_jogador_in)
                break
            else:
                if int(self._up_aposta_entrada_jogador_) in self.lista_valor_aposta:
                    self._up_aposta_entrada_jogador_in = {"{}".format("Aposta"):self._up_aposta_entrada_jogador_}
                    self.dic_b_novo_jogador_aposta.update(self._up_aposta_entrada_jogador_in)
                    break
                else:
                    print("\033[31mO valor digitado não é uma aposta válida.\033[m")
                    continue
        if self._up_aposta_entrada_jogador_ == "1":
            self.cartera_jogador.append(self.cartera_jogador[0] - min(self.lista_valor_aposta))

        elif self._up_aposta_entrada_jogador_ == "2":
            self.cartera_jogador.append(self.cartera_jogador[0] - max(self.lista_valor_aposta))

        else:
            self.cartera_jogador.append(self.cartera_jogador[0]-int(self._up_aposta_entrada_jogador_))
        ...
        self.dic_b_novo_li_jogador_aposta = list(self.dic_b_novo_jogador_aposta.items())
        ...
        self.dic_b_novo_li_crouper = list(self.dic_b_novo_crouper.items())
        self.dic_b_novo_crouper_soma.append(self.dic_b_novo_li_crouper[0][1] + self.dic_b_novo_li_crouper[1][1])
        ...
        self.dic_b_novo_li_jogador = list(self.dic_b_novo_jogador.items())
        self.dic_b_novo_jogador_soma.append(self.dic_b_novo_li_jogador[0][1] + self.dic_b_novo_li_jogador[1][1])
            ...
            if self.loop_stop[0] == 1:
                ...
                if self._up_reaposta_entrada_jogador_li[0] == 1:
                    if self.dic_b_novo_crouper_soma[0] < 21:
                        ...
                        self.dic_b_novo_crouper_soma[0] = self.dic_b_novo_crouper_soma[0] + self.valor_crouper
                        self.dic_b_novo_li_crouper.append(self.ind_val_format_li)
                ...
                if self._up_reaposta_entrada_jogador_li[0] == 0 or self._up_reaposta_entrada_jogador_li[0] >= 2:
                    print("Carta 1: {0}".format(self.dic_b_novo_li_crouper[0][0]))
                    print("Carta 2: **")
                    print("\033[1mSoma: {}\033[m".format(self.dic_b_novo_li_crouper[0][1]))
                else:
                    yy = 0
                    ...
                    if self.dic_b_novo_crouper_soma[0] > 21:
                        print("\033[1mSoma: {}\033[m \033[31mESTOROU\033[m!".format(self.dic_b_novo_crouper_soma[0]))
                        self.quem_ganhou[0] = 1
                        self.loop_stop[0] = 0

                    elif self.dic_b_novo_crouper_soma[0] == 21:
                        print("\033[1mSoma: {}\033[m \033[33mBLACKJACK!!\033[m!".format(self.dic_b_novo_crouper_soma[0]))
                        self.quem_ganhou[0] = 0
                    else:
                        print("\033[1mSoma: {}\033[m ".format(self.dic_b_novo_crouper_soma[0]))
                ...
                print("\033[36mCarteira:\033[m ${}".format(self.cartera_jogador[len(self.cartera_jogador)-1]))
                print("\033[33mSuas cartas:\033[m")
                print("Aposta: ${0}".format(self.dic_b_novo_jogador_aposta["Aposta"]))
                ...
                if self._up_reaposta_entrada_jogador_li[0] != 4:
                    ...
                    for x in self.dic_b_novo_li_jogador:
                        ...
                        xx += 1
                    self.soma_divisao1 = self.dic_b_novo_li_jogador[0][1] + self.dic_b_novo_li_jogador[2][1]
                    ...
                    for x in self.dic_b_novo_li_jogador:
                        ...
                        xx += 1
                    self.soma_divisao2 = self.dic_b_novo_li_jogador[1][1] + self.dic_b_novo_li_jogador[3][1]
                ...
                if self.dic_b_novo_jogador_soma[0] > 21:
                    print("\033[1mSoma: {}\033[m \033[31mESTOROU\033[m!".format(self.dic_b_novo_jogador_soma[0]))
                    self.quem_ganhou[0] = 0
                    self.loop_stop[0] = 0

                elif self.dic_b_novo_jogador_soma[0] == 21:
                    print("\033[1mSoma: {}/21\033[m \033[33mBLACKJACK!!\033[m!".format(self.dic_b_novo_crouper_soma[0]))
                    self.quem_ganhou[0] = 1
                else:
                    if self._up_reaposta_entrada_jogador_li[0] != 4:
                        print("\033[1mSoma: {}\033[m".format(self.dic_b_novo_jogador_soma[0]))
                    else:
                        pass
                ...
                if self.quem_ganhou[0] == 0:
                    ...
                    self.cartera_jogador.append(self.cartera_jogador[len(self.cartera_jogador)-1]+int(self.dic_b_novo_li_jogador_aposta[0][1]))
                    self.soma_resu_aposta = self.cartera_jogador[1]
                    print("\033[36mSua Carteira atualizada é:\033[m ${}".format(self.soma_resu_aposta))
                    break

                if self.quem_ganhou[0] == 1:
                    print("\033[35mVOCÊ GANHOU!!\033[m!")
                    self.cartera_jogador.append(self.cartera_jogador[len(self.cartera_jogador)-1]+int(self.dic_b_novo_li_jogador_aposta[0][1]))
                    self.soma_resu_aposta = self.dic_b_novo_jogador_aposta["Aposta"] + self.cartera_jogador[1]
                    print("\033[36mSua Carteira atualizada é:\033[m ${}".format(self.soma_resu_aposta))
                    break
                ...
                if self.dic_b_novo_li_jogador.__len__() == 4:
                    ...
                    while yyy <= 1:
                        ...
                        if self.dic_b_novo_li_crouper[0][0]in self.dic_b_novo_li_jogador_A \
                            ...
                            if self.loop_msg.__len__() == 1:
                                self._up_reaposta_entrada_jogador_ = input("\033[34m{0}\033[m(1)\n\033[34m{1}\033[m(2)\n"
                                                                           ...
                                                                           "\033[34m{4}\033[m(4)\n\033[34m{5}\033[m(5)\n".format(
                                    self._up_aposta_lista[1],self._up_aposta_lista[2],self.dic_b_novo_jogador_aposta["Aposta"],
                        ...
                        self.msg_divisao.append(self._up_reaposta_entrada_jogador_)
                ...
                self._up_reaposta_entrada_jogador_li[0] = int(self._up_reaposta_entrada_jogador_)
                if self._up_reaposta_entrada_jogador_li[0] == 3:
                    self.multipli = {"{}".format("Aposta"):self.dic_b_novo_jogador_aposta["Aposta"]*2}
                    ...
                    self.ind_val_format = {"{}".format(self.indice_jogador): self.valor_jogador}
                    self.ind_val_format_li = list(self.ind_val_format)
                    self.dic_b_novo_jogador_soma[0] = self.dic_b_novo_jogador_soma[0] + self.valor_jogador
