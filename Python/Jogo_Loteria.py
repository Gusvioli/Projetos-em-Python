...
while lo <= 10:
    ...
    if qual_Jogo == "0":
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 6 a 15:")
        if int(numero) >= 6 and int(numero) <= 15:
            n.append("Seu jogo é Mega sena")
            while x <= int(valor):
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 5 a 15:")
        if int(numero) >= 5 and int(numero) <= 15:
            n.append("Seu jogo é Quina")
            while x <= int(valor):
                n.append(random.sample(range(1, 60), int(numero)))
                x += 1
            print(
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 15 a 20:")
        if int(numero) >= 15 and int(numero) <= 20:
            n.append("Seu jogo é Lotofácil")
            while x <= int(valor):
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar 10 numeros:")
        if int(numero) == 10:
            n.append("Seu jogo é Time mania")
            while x <= int(valor):
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 6 a 15:")
        if int(numero) >= 6 and int(numero) <= 15:
            n.append("Seu jogo é Dupla sena")
            while x <= int(valor):
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 7 a 15:")
        if int(numero) >= 7 and int(numero) <= 15:
            n.append("Seu jogo é Dia de sorte")
            while x <= int(valor):
        ...
        numero = input(
            "Digite quantos numeros voce gostaria de jogar de 7 a 21:")
        if int(numero) >= 7 and int(numero) <= 21:
            n.append("Seu jogo é Super sete")
            while x <= int(valor):
